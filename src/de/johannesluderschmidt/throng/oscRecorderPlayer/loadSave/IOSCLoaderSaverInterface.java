...
public interface IOSCLoaderSaverInterface {
	ArrayList<OSCRecordedPacket> getRecordedPackets();
	void setRecordedPackets(ArrayList<OSCRecordedPacket> recordedPackets);
}
