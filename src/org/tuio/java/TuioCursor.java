...
public class TuioCursor extends TuioContainer {
	 ...
	 */
	public TuioCursor (TuioTime ttime, long si, int ci, float xp, float yp, String src, long fseq) {
	 ...
	 * @param	yp	the Y coordinate to assign
	 */
	public TuioCursor (long si, int ci, float xp, float yp, String src, long fseq) {
