...
abstract class TuioContainer extends TuioPoint {
	 ...
	 */
	TuioContainer(TuioTime ttime, long si, float xp, float yp, String src, long fseq) {
		super(ttime,xp,yp);
	 ...
	 * @param	yp	the Y coordinate to assign
	 */
	TuioContainer(long si, float xp, float yp, String src, long fseq) {
		super(xp,yp);
	 ...
	 * @param	yp	the Y coordinate to assign
	 */
	public void update(TuioTime ttime, float xp, float yp, long fseq) {
	 ...
	 */
	public void update(TuioTime ttime, float xp, float yp , float xs, float ys, float ma, long fseq) {
		super.update(ttime,xp,yp);
		x_speed = xs;
		y_speed = ys;
