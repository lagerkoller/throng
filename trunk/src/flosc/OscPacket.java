...
public class OscPacket {
   ...
   */
	...
	public Vector<OscMessage> getMessages() {
		return messages;
	}


	public void setMessages(Vector<OscMessage> messages) {
		this.messages = messages;
	}

	public String toString(){
		String oscPacketString = "";
		oscPacketString = oscPacketString + "address: " + address;
		oscPacketString = oscPacketString + ", port: " + port;
		oscPacketString = oscPacketString + ", messages:";
		int i = 1;
		for(OscMessage message:messages){
			oscPacketString = oscPacketString +"\n\t" + i+": <" + message.toString()+">";
			i = i+1;
		}
		return oscPacketString;
	}
}
