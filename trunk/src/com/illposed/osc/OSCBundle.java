...
public class OSCBundle extends OSCPacket {
	...
	public String toString(){
		String oscBundleString = "";
//		oscBundleString = oscBundleString + "address: " + ipAddress;
//		oscBundleString = oscBundleString + ", port: " + portOut;
//		oscBundleString = oscBundleString + ", messages:";
		int i = 1;
//		oscBundleString = oscBundleString +"\n";
//		oscBundleString = oscBundleString +timestamp.getTime()+"\n";
//		oscBundleString = oscBundleString +ipAddress.getHostAddress()+"\n";
//		oscBundleString = oscBundleString +portOut+"\n";
		for(OSCPacket packet:getPackets()){
			OSCMessage message = (OSCMessage) packet; 
//			oscBundleString = oscBundleString +"\n\t" + i+": <" + message.toString()+">";
			oscBundleString = oscBundleString + message.toString()+"\n";
			i = i+1;
		}
		return oscBundleString;
	}
